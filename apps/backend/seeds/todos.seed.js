...
function randomDescription(i) {
    ...
    return "".concat(actions[Math.floor(Math.random() * actions.length)], " #").concat(i);
}
function main() {
    return __awaiter(this, void 0, void 0, function () {
        var users, todos, i, user;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    return [4 /*yield*/, prisma.todo.createMany({
                            data: todos,
                            skipDuplicates: true,
                        })];
                case 2:
